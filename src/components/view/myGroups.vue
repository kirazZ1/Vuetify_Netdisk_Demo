      ...
      <v-list >
        ...
        <v-list-item-group color="primary">
          <v-list-item
              ...
              :key="i"
              @click="accessGroup(item)"
          >
            <v-list-item-icon>
              <v-icon>mdi-folder</v-icon>
            </v-list-item-icon>
            <v-list-item-content>
              <v-list-item-title v-text="item.departName"></v-list-item-title>
            </v-list-item-content>
          </v-list-item>
        </v-list-item-group>
      </v-list>
    </v-card>
    <v-container v-show="showGroupFile">
      <v-card>
        <v-row>
          <v-col md="7">
            <v-row>
              ...
              <div class="ma-1 pa-1"></div>
              <div class="ma-1 pa-1">
                <v-btn  color="primary"  @click="BackToList()">
...
//     "departName": "某某群组",
//     "departTime": "Tue Sep 29 02:49:47 UTC 2020",
//     "permission": "00000000"
// },
  name: "myGroup",
  data(){
    return{
      // items: [
      //   { departID:"",departName: '', departTime:"",permission: ""},
      //   // { departID:"10002",departName: '策划部', departTime:"Tue Sep 29 02:49:47 UTC 2020",permission: "00000000"},
      //   // { departID: '10003',departName: '技术部', departTime:"Tue Sep 29 02:49:47 UTC 2020",permission: "00000000"},
      //   // { departID: '10004',departName: '魔法部', departTime:"Tue Sep 29 02:49:47 UTC 2020",permission: "00000000"},
      // ],
      listItems:null,
      showGroupFile:false,
      groupList:true,
